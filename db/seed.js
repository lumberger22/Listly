...
async function seed() {
  ...
  const users = [
    { username: "admin",      email: "admin@listly.com",    address: null,                          is_admin: 1 },
    { username: "alex_sells", email: "alex@example.com",    address: "123 Maple St, Austin TX",     is_admin: 0 },
    { username: "brianna_b",  email: "brianna@example.com", address: "88 Oak Ave, Denver CO",       is_admin: 0 },
    { username: "carlos_c",   email: "carlos@example.com",  address: "42 Pine Rd, Miami FL",        is_admin: 0 },
    { username: "diana_d",    email: "diana@example.com",   address: "9 Birch Ln, Seattle WA",      is_admin: 0 },
    { username: "evan_e",     email: "evan@example.com",    address: "301 Cedar Blvd, Chicago IL",  is_admin: 0 },
  ];

  const uids = [];
  for (const u of users) {
    const r = await q("INSERT INTO User (Username, Password, Email, Address, is_admin) VALUES (?, ?, ?, ?, ?)",
      [u.username, pass, u.email, u.address, u.is_admin]);
